namespace СельскоеХозяйство
{
    partial class ОкноОтчётов
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ОкноОтчётов));
